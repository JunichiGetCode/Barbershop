...
<head>
    ...
    <title>Data Pelanggan | Barbershop Admin</title>
...
<body>
    ...
    <div class="main">
        <div class="topbar">
            ...
            <span>Manajemen Kontak Pelanggan</span>
        </div>
        ...
        <div class="card" style="background: white; color: #333; margin-bottom: 20px;">
            <h4 style="margin-bottom: 15px;">Tambah Pelanggan Baru</h4>
            <form action="{{ route('pelanggan.store') }}" method="POST">
                @csrf
                <div style="display: flex; gap: 15px;">
                    <div style="flex: 1;">
                        <input type="text" name="nama" placeholder="Nama Pelanggan" required style="margin: 0; width: 100%;">
                    </div>
                    
                    <div style="flex: 1;">
                        <input type="number" name="no_hp" placeholder="Nomor HP / WhatsApp" required style="margin: 0; width: 100%;">
                    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="https://wa.me/{{ $item->no_hp }}" target="_blank" style="text-decoration: none; color: #25d366; font-weight: bold;">
                            <i class="fa-brands fa-whatsapp"></i> {{ $item->no_hp }}
                        </a>
                    </td>
                    <td>
                        <button onclick="openEditModal({{ $item->id }}, '{{ $item->nama }}', '{{ $item->no_hp }}')" 
                                class="btn-warning">
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            <h3 style="margin-bottom: 20px;">Edit Data Pelanggan</h3>
    ...
    <script>
        // --- Logic Modal Edit ---
        function openEditModal(id, nama, noHp) {
